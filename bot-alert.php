...
// Handle form POST to save chat ID
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['chat_id'])) {
    $chat_id = trim($_POST['chat_id']);
    $userData['chat_id'] = $chat_id;
    file_put_contents($userPath, json_encode($userData, JSON_PRETTY_PRINT));
...
<!--div class="marquee-card">
  <marquee> Welcome to <b>Pavan Cash Loot</b>!
  </marquee>
</div-->
...
<div class="card">
    ...
    <?php if (!$chatIdMissing): ?>
        <div class="statuss" style="display: flex;">
           ...
           <b>Bot alerts are  <b> active</b>. Updates will be sent via</b>
        </div>
        <div class="statuss" style="display: flex;">

           <span class="material-icons">smart_toy</span>
           
            <a class="bot-link" href="https://t.me/SmartxlifafaVerifier_bot">@SmartxlifafaVerifier_bot</a>
        </div>
    <?php else: ?>
    ...
    <div class="change-id statuss" style="display: flex; align-items: center; ">
        <span class="material-icons">sync</span>
      <b>  <?= $chatIdMissing ? "<b>Link your Telegram Chat ID</b>" : "<b>Update Telegram Chat ID</b>" ?></b>
    </div>

    <form method="POST">
        <div class="group11">
  <!--label style="font-weight: 600; margin-bottom: 5px;">Enter Your Telegram Chat ID:</label-->

    <input 
      class="input11" 
      type="text" 
      name="chat_id" 
      value="<?= htmlspecialchars($userData['chat_id'] ?? '') ?>" 
      placeholder="e.g., 123456789" 
      required
    >
    <!-- Telegram SVG Icon -->
    <svg viewBox="0 0 240 240" class="icon11">
      <path fill="#89CFF0" d="M120,0C53.728,0,0,53.728,0,120c0,66.272,53.728,120,120,120s120-53.728,120-120C240,53.728,186.272,0,120,0z M178.128,77.024l-19.36,91.68c-1.44,6.368-5.216,7.968-10.56,4.96l-29.216-21.504l-14.112,13.6c-1.552,1.552-2.848,2.848-5.824,2.848l2.08-29.6l53.84-48.544c2.336-2.08-0.512-3.2-3.648-1.12l-66.544,41.888l-28.704-9.008c-6.24-1.952-6.368-6.24,1.28-9.216l111.84-43.12C174.88,66.336,180.288,69.12,178.128,77.024z"/>
    </svg>
...
<div class="flex justify-center items-center w-full">
  ...
  <span><?= $chatIdMissing ? "<b>Link Telegram</b>" : "<b>Update ID</b>" ?></span>
</button>
</div>
    </form>

    <?php if ($message): ?>
        <div class="message"><b><?= htmlspecialchars($message) ?></b></div>
    <?php endif; ?>
